...
namespace Range
{
    public class ManyTheories
    {
        ...
        public void ReturnsAMatchWithATextInWitchTheCharacterPatternIsConsumedEntirely(string text, string remainingText)
        {
        ...
        [InlineData("ab", "ab")]
        public void ReturnsAMatchWithATextInWitchTheRangePatternIsConsumedEntirely(string text, string remainingText)
        {
